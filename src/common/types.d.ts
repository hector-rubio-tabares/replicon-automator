...
export type IPCChannels = 'automation:start' | 'automation:stop' | 'automation:pause' | 'automation:progress' | 'automation:log' | 'automation:complete' | 'automation:error' | 'csv:load' | 'csv:generate' | 'csv:save' | 'config:get' | 'config:set' | 'credentials:save' | 'credentials:load' | 'credentials:clear';
 ...
 */
export type NestedTranslation = string | {
