...
type TabId = 'automation' | 'csv-editor' | 'config';
export default function App() {
  ...
  const csvEditorStore = useCSVEditorStore();
  ...
  const handleStart = useCallback(async () => {
    ...
    // Pasar el mes seleccionado desde el CSV Editor Store
    await automation.start({ 
      ...
      selectedMonth: {
        year: csvEditorStore.selectedYear,
        month: csvEditorStore.selectedMonth
      }
    });
  }, [csv.data, credentials, automation, config.horarios, config.mappings, config.appConfig, csvEditorStore.selectedYear, csvEditorStore.selectedMonth, t, toast]);
